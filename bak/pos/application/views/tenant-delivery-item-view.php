...
<script>
	...
	function removeItem(item,delivery,qty,dt,dtotal){
		...
		$.ajax({
			url: '<?php echo base_url(); ?>tenant/remove-delivery-item',
				type: "POST",
	...
	function confirmQty(dt_id){
		...
		$.ajax({
			url: '<?php echo base_url(); ?>tenant/edit-delivery-item',
				type: "POST",
					...
					<div class="col-xs-5">
						...
						<div class="col-xs-12">
							...
							<div class="row table-title table-title-general table-title-income">
								<?php if($dt_status == 0){ ?><div class="col-xs-1"></div><?php } ?>
							...
							?>
								...
								<div id="delrow<?php echo $delivery_id; ?>" class="row del-rows table-entries table-entries-income">
									...
									<?php } ?>
									<div class="col-xs-1 del-qty" id="quant<?php echo $delivery_id; ?>" <?php if($dt_status == 0){ ?> onClick="editItem(<?php echo $delivery_id; ?>,<?php echo $delivery_quantity; ?>);" <?php } ?> ><?php echo $delivery_quantity; ?></div>
